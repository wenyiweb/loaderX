...
var _LoaderImage = _interopRequireDefault(require("./LoaderImage"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function LoaderX(settings) {
  // merge settings with defaults
  settings = settings || {};
  this.settings = settings; // how frequently we poll resources for progress
  ...
  this.add = function (resource) {
    ...
    // initialize the LoaderXTags there rather than overwritting tags here
    resource.tags = new LoaderXTags(resource.tags); // ensure priority is set
  ...
  this.start = function (orderedTags) {
    ...
    console.log(timeStarted); // first order the resources

    var compareResources = getResourceSort(orderedTags);
    entries.sort(compareResources); // trigger requests for each resource
  ...
  var onProgress = function onProgress(resource, statusType) {
    var entry = null,
        ...
        numResourceTags,
        listener,
        shouldCall; // find the entry for the resource
    ...
    progressChanged = Date.now();
    numResourceTags = resource.tags.length; // fire callbacks for interested listeners
  ...
  var log = this.log = function (showAll) {
    ...
    window.console.log('LoaderX elapsed: ' + elapsedSeconds + ' sec');
    ...
    for (var i = 0, len = entries.length; i < len; i++) {
      ...
      var message = 'LoaderX: #' + i + ' ' + entry.resource.getName();
...
LoaderXTags.prototype.intersects = function (other) {
...
LoaderX.prototype.addImage = function (url, tags, priority, origin) {
  var imageLoader = new _LoaderImage["default"](url, tags, priority, origin);
